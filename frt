            ...
            if game.Players.LocalPlayer.leaderstats.LV.Value >= 6000 then
                if game.Players.LocalPlayer.leaderstats.TP.Value >= 70 then
                    if game.Players.LocalPlayer.leaderstats.Gold.Value >= 30000000 then
                        ...
                        boss()
                        repeat
                            if game.Players.LocalPlayer.leaderstats.Reset.Value == 0 then break
                            end
                            if _G.sslot.Bosses["1"]:FindFirstChild("Boss2") then
                                resetboss()
                                if game.Players.LocalPlayer.leaderstats.Reset.Value == 1 then break
                                end
                            end
                            if _G.sslot.Bosses["1"]:FindFirstChild("Boss3") then
                                resetboss()
                                if game.Players.LocalPlayer.leaderstats.Reset.Value < 5 then break
                                end
                            end
                            if _G.sslot.Bosses["1"]:FindFirstChild("Boss4") then
                                resetboss()
                                if game.Players.LocalPlayer.leaderstats.Reset.Value < 10 then break
                                end
                            end
                            if _G.sslot.Bosses["1"]:FindFirstChild("Boss5") then
                                resetboss()
                                if game.Players.LocalPlayer.leaderstats.Reset.Value < 15 then break
                                end
                            end
                            if _G.sslot.Bosses["1"]:FindFirstChild("Boss6") then
                                resetboss()
                                if game.Players.LocalPlayer.leaderstats.Reset.Value < 20 then break
                                end
                            end
                            if _G.sslot.Bosses["1"]:FindFirstChild("Boss7") then
                                resetboss()
                                if game.Players.LocalPlayer.leaderstats.Reset.Value < 25 then break
                                end
                            end
                            if _G.sslot.Bosses["1"]:FindFirstChild("Boss8") then
                                resetboss()
                                if game.Players.LocalPlayer.leaderstats.Reset.Value < 30 then break
                                end
                            end
                            if _G.sslot.Bosses["1"]:FindFirstChild("Boss9") then
                                resetboss()
                                if game.Players.LocalPlayer.leaderstats.Reset.Value >= 30 then break
                                end
                            end
